...
def parse_args():
    ...
    parser.add_argument(
        ...
        '--override',
        action='append',
        default=['Global.pretrained_model=pretrained_model_download/ResNet50/ResNet50_pretrained'],
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='s4  model.bin path'
    )
    args = parser.parse_args()
    
    override_s4_cmd = f'Global.s4_model_path={args.s4_model_path}'
    args.override.append(override_s4_cmd)
    return args
